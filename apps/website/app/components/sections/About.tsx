      ...
      <div className="container">
        ...
        <div className="about-grid">
          ...
          <ScrollTextHighlight className="about-text" dimOpacity={0.18} blurAmount={1.5}>
            ...
            <p>
              <strong>ביחד אנחנו מכסים את כל המסלול הטכני:</strong> מוצר, אוטומציה, ותהליכי מכירה. אותו ראש יושב על התהליך העסקי, על האוטומציה ועל הקוד, כך שאף אחד לא מגלגל אחריות הלאה כשמשהו נתקע באמצע.
            </p>
