...
const steps = [
  ...
  },
  {
    n: '02',
    title: 'בוחרים חבילה',
    text: 'אוטומציה, סוכן AI, או בנק שעות פיתוח. יודעים בדיוק מה כלול ומה עולה.',
  },
  {
    n: '03',
    title: 'אפיון ותוכנית עבודה',
    text: 'איזה תהליך מתאמת, אילו מערכות מתחברות, ומה הבוט עונה. תוכנית ברורה לפני שמתחילים.',
  },
  {
    n: '04',
    title: 'עולים לאוויר ומעדכנים',
    text: 'האוטומציה רצה בייצור. פגישת סטטוס שבועית וזמינות יומיומית לכל שאלה.',
  },
];
