...
const plans: Plan[] = [
  {
    ...
    items: ['משתמש 1 (פרילנסר)', '500 פעולות בחודש', '100 הודעות וואטסאפ חינם', 'כל היכולות המרכזיות', 'תמיכה במייל'],
    benefits: ['חודש ראשון חינם', 'בלי התחייבות', 'עברית מלאה'],
  },
  {
    ...
    items: ['עד 5 משתמשים', '5,000 פעולות בחודש', '500 הודעות וואטסאפ חינם', 'ריבוי ערוצים + אנליטיקס', 'תמיכה מהירה'],
    benefits: ['חודש ראשון חינם', 'הכי משתלם', 'בול ב-WTP הישראלי'],
  },
  {
    ...
    benefits: ['חודש ראשון חינם', 'API מלא', 'מוכן לסוכנויות'],
  },
  {
    ...
    benefits: ['חודש ראשון חינם', 'חיסכון מיידי', 'ניהול אחד'],
  },
  {
    ...
    benefits: ['חודש ראשון חינם', 'הכי משתלם למרובי-כלים'],
  },
  {
    ...
    benefits: ['חודש ראשון חינם', 'הערך המקסימלי'],
