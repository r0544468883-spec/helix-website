...
const logos = [
  ...
  { src: '/logos/perplexity.svg',  alt: 'Perplexity',  ext: 'svg' },
  ...
  { src: '/logos/nodejs.png',      alt: 'Node.js',     ext: 'png' },
  { src: '/logos/react.svg',       alt: 'React',       ext: 'svg' },
  { src: '/logos/docker.svg',      alt: 'Docker',      ext: 'svg' },
  { src: '/logos/stripe.svg',      alt: 'Stripe',      ext: 'svg' },
