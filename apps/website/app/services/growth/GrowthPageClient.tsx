...
export default function GrowthPageClient() {
  return (
    <div className="service-page">
      {/* ──── 1. HERO ──── */}
      <ServiceHero
        eyebrow="חבילה 02 · Growth Hacking"
      ...
      <section className="sp-narrative">
        <div className="container">
          <ScrollTextHighlight className="sp-narrative-block" dimOpacity={0.12} blurAmount={1.5}>
            ...
            <p>
              1,250 ₪ לחודש על Growth Hacking מלא, אסטרטגיה, ניסויים, AI chatbot, דשבורד ופגישה שבועית. זה לא מבצע, ככה נראית הגינות.
            </p>
          </ScrollTextHighlight>
        </div>
      </section>
      ...
      <ForWhoSection
        ...
        no={[
          'מי שרוצה "רק קמפיין ממומן" בלי מנגנון צמיחה מאחוריו',
