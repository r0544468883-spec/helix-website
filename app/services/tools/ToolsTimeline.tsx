...
const steps = [
  {
    n: '01',
    title: 'שיחת היכרות',
    text: 'מבינים מה העסק צריך, מראים את התוכנות הרלוונטיות, ובודקים אם יש התאמה. בלי לחץ — שיחה אמיתית.',
  },
  {
    n: '02',
    title: 'שבוע ניסיון חינם',
    text: 'מקבלים גישה מלאה לתוכנה. משתמשים, בודקים, מחליטים. בלי כרטיס אשראי, בלי התחייבות.',
  },
  {
    n: '03',
    title: 'הטמעה והדרכה',
    text: 'מחברים את התוכנה למערכות הקיימות. הדרכה צמודה עד שהצוות עובד בביטחון.',
  },
  {
    n: '04',
    title: 'תמיכה ועדכונים שוטפים',
    text: 'תמיכה מלאה, עדכוני גרסה, ופיצ׳רים חדשים. צריכים התאמה אישית? בנק שעות פיתוח תמיד פתוח.',
  },
];
  ...
  return (
    <section className="how-it-works" id="method">
      <div className="container">
        <SectionHeader
          eyebrow="איך מתחילים"
          titleHtml="מהשיחה הראשונה<br/>לתוכנה שעובדת."
          description="ארבעה שלבים. שבוע ניסיון. בלי סיכון."
        />
