  ...
  return (
    <div className="service-page">
        ...
        cards={[
          {
            ...
            text: 'שילמת כל חודש, ראית "תוצאות" בפרזנטציה יפה — ובחשבון הבנק לא זז כלום. מי שניהל לך את הקמפיין אופטימייז על קליקים, לא על לקוחות. הילדים הטובים לא עובדים ככה.',
          },
          {
            title: 'אף אחד לא מבין מה קורה עם הכסף שלך',
            text: '"הגענו ל-80,000 חשיפות אורגניות" — כל הכבוד, אבל מה זה שווה? אצלנו מדברים על לידים, עלות לליד, ועסקאות שנסגרו. כי הילדים הטובים מראים מספרים אמיתיים.',
          },
          {
            title: 'כל חודש מישהו חדש מטפל בך',
            text: 'אחרי שלושה חודשים החשבון עבר למישהו אחר שלא מכיר אותך ולא מכיר את העסק שלך. הילדים הטובים לא מעבירים אותך — ערן ורון מטפלים אישית בכל לקוח.',
          },
        ]}
      />
      ...
      <FeaturesSection
        ...
        lead="כל מה שסוכנות שיווק גובה עליו 8,000+ — הילדים הטובים עושים ב-1,250 ₪. AI חתך לנו 60% מהעבודה, ואנחנו מעבירים את החיסכון אליכם."
        stats={[
      ...
      <section className="sp-narrative">
        <div className="container">
          <ScrollTextHighlight className="sp-narrative-block" dimOpacity={0.12} blurAmount={1.5}>
            ...
            <p>
              הילדים הטובים החליטו אחרת. להעביר את החיסכון אליכם.
              1,250 ₪ זה לא מחיר מבצע — זה המחיר שהגינות נראית כמוהו.
            </p>
          </ScrollTextHighlight>
        </div>
      </section>
      ...
      <ForWhoSection
        yes={[
          ...
          'בעל עסק שנשרף מסוכנות יקרה ומחפש את הילדים הטובים',
      ...
      <FinalCTA
        ...
        subtitle="הילדים הטובים מחכים לשיחה. שיחת אסטרטגיה ראשונה בחינם — בלי התחייבות. תספר לנו על העסק, נגיד לך בכנות אם אנחנו יכולים לעזור. אם לא — נגיד גם את זה."
        ctaHref={wa}
        ctaText="בואו נדבר"
      />
