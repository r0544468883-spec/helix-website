...
export default function AutomationPageClient() {
  return (
    <div className="service-page">
      {/* ──── 1. HERO (no price) ──── */}
      <ServiceHero
        eyebrow="חבילה 01 · אוטומציות וסוכני AI"
        ...
        price="החל מ-185 ₪"
        priceNote="תשלום חד-פעמי · חבילות הקמה · תמיכה חודשית אופציונלית · מיפוי ראשוני חינם"
        ctaHref={wa}
      >
          ...
          <div className="faq-with-image">
            <ScrollTextHighlight className="faq-list" dimOpacity={0.2} blurAmount={1}>
              ...
              <FAQItem question="כמה עולה אוטומציה ב-HELIX?">
                <p>חבילות הקמה חד-פעמיות מ-185 ₪. בלי חוזה, בלי דמי הקמה. מיפוי תהליכים ראשוני חינם.</p>
              </FAQItem>
