...
const tools = [
  ...
  { name: 'TypeScript', sub: 'Type Safety', icon: '🔷', x: 48, y: 35 },
  { name: 'HubSpot', sub: 'CRM', icon: '🧡', x: 88, y: 36 },
  { name: 'RAG', sub: 'Vector Search', icon: '🧠', x: 28, y: 40 },
  { name: 'WhatsApp API', sub: 'Bots', icon: '📲', x: 62, y: 42 },
  { name: 'Supabase', sub: 'Postgres', icon: '🗄', x: 18, y: 50 },
  { name: 'LinkedIn', sub: 'B2B Network', icon: '💼', x: 42, y: 48 },
  { name: 'Airtable', sub: 'Ops Data', icon: '📋', x: 75, y: 48 },
  { name: 'Twilio', sub: 'Messaging', icon: '📞', x: 55, y: 55 },
  { name: 'Playwright', sub: 'Scraping', icon: '🕸', x: 8, y: 58 },
  { name: 'React', sub: 'Frontend', icon: '⚛', x: 32, y: 58 },
  { name: 'Node.js', sub: 'Backend', icon: '🟢', x: 85, y: 55 },
  { name: 'Figma', sub: 'App Screens', icon: '▢', x: 68, y: 62 },
  { name: 'Zapier', sub: 'Integrations', icon: '⚙', x: 22, y: 68 },
  { name: 'Cursor', sub: 'AI IDE', icon: '▶', x: 48, y: 66 },
  { name: 'Vercel', sub: 'Deploy', icon: '▲', x: 78, y: 70 },
  { name: 'AWS', sub: 'Cloud', icon: '☁', x: 10, y: 75 },
  { name: 'Docker', sub: 'DevOps', icon: '🐳', x: 60, y: 76 },
  { name: 'PostHog', sub: 'Product Analytics', icon: '📉', x: 38, y: 78 },
