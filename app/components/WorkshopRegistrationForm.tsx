...
type Props = {
  /** API endpoint the form POSTs to (e.g. /api/vibe-code-register). */
  endpoint: string;
  /** WhatsApp group invite shown on success. Button is hidden when empty. */
  whatsappGroup?: string;
};

export default function WorkshopRegistrationForm({ endpoint, whatsappGroup }: Props) {
