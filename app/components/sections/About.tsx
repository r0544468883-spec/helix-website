      ...
      <div className="container">
        ...
        <div className="about-grid">
          ...
          <ScrollTextHighlight className="about-text" dimOpacity={0.18} blurAmount={1.5}>
            ...
            <p>
              <strong>ביחד אנחנו מכסים את כל המסלול:</strong> מוצר, אוטומציה, ומכירות. Dev + Go-to-Market תחת קורת גג אחת, בדיוק מה שעסקים קטנים מאבדים כשהם עובדים עם 3 ספקים שלא מדברים אחד עם השני.
            </p>
            ...
            <p>
              <strong>HELIX זה הניסיון שלנו לעשות אחרת.</strong> גם הקוד, גם האוטומציה, גם הצמיחה, גם השקיפות. תחת קורת גג אחת.
            </p>
