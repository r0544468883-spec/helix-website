...
const packages: Pkg[] = [
  ...
  },
  {
    ...
    addons: [['צ׳אטבוט נוסף','600 ₪/חודש'],['דשבורד ניסויים','650 ₪/חודש'],['דוח מתחרים חודשי','350 ₪/חודש']],
  ...
  },
  {
    ...
    addons: [['העשרת רשומות B2B','490 ₪/חודש'],['מענה לפניות נכנסות בלינקדין','390 ₪/חודש'],['סדרת מסרים מותאמת','650 ₪/חודש'],['פולואפ אימייל קר','350 ₪/חודש'],['רשימת לקוחות פוטנציאליים','850 ₪/חודש'],['זיהוי לידים חמים','550 ₪/חודש'],['פנייה רב-ערוצית','1,100 ₪/חודש']],
    href: '/products/sdr',
  },
  {
    ...
    <section className="pkc-section" id="packages">
      ...
      <div className="container">
        <div className="pkc-header">
          ...
          <h2 className="pkc-title">אוטומציות, סוכני AI ופיתוח.</h2>
          <p className="pkc-subtitle">חמש חבילות. בלי חוזה, בלי דמי הקמה. החל מ-300 ₪.</p>
        </div>
