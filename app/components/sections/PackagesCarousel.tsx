...
const packages: Pkg[] = [
  ...
  {
    tag: 'חבילה 03', name: 'אוטומציות וסוכני AI', price: '300', market: '4,000–7,000',
  ...
  },
  {
    ...
    addons: [['העשרת רשומות B2B','490 ₪/חודש'],['ניהול תיבת LinkedIn','390 ₪/חודש'],['סדרת מסרים מותאמת','650 ₪/חודש'],['פולואפ אימייל קר','350 ₪/חודש'],['רשימת לקוחות פוטנציאליים','850 ₪/חודש'],['זיהוי לידים חמים','550 ₪/חודש'],['פנייה רב-ערוצית','1,100 ₪/חודש']],
    href: '/services/sales',
  },
  {
