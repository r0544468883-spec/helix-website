...
const reviews = [
  ...
  },
  {
    ...
    headline: 'עסק עונתי שלא יודע מאיפה יבוא הבא',
    text: 'בקיץ עמוסים, בחורף שקט. HELIX בנו לי אוטומציה שמחזיקה לידים גם מחוץ לעונה, והיום יש לי יומן עומד שלא תלוי בגחמות השוק.',
  },
  {
    name: 'שירה מנחם',
