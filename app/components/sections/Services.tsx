...
export const corePackages: Package[] = [
  ...
  },
  {
    ...
    items: [
      'אפיון ואסטרטגיית אתר',
      'עיצוב UX/UI ופיתוח מלא',
      'אתר תדמית · דף נחיתה · אתר עסקי',
  ...
  },
  {
    ...
    items: [
      ...
      'עיצוב UX/UI ופיתוח חנות מלא',
      'חיבור תשלומים, משלוחים וניהול מלאי',
      'חיבור פיקסלים, אוטומציות ו-WhatsApp',
      'SEO בסיסי + תחזוקה ואופטימיזציית מכירות שוטפת',
      'דוח חודשי מפורט',
      'פגישה שבועית של 30 דקות',
    ],
    bonuses: ['בלי חוזה, ביטול בכל עת', 'בלי דמי הקמה', 'שיחה ראשונית לאפיון חנות ללא עלות', '20% הנחה ליזמים, סטארטאפים ועסקים קטנים'],
    addons: [
      { name: 'עמוד מוצר/קטגוריה נוסף', price: '480 ₪ · חד פעמי' },
      { name: 'חיבור CRM למערכת הזמנות', price: 'החל מ-650 ₪' },
      { name: 'הקמת מערכת דיוור', price: '750 ₪ · חד פעמי' },
      { name: 'סדרת אימיילים אוטומטית', price: '350 ₪ · לשעה' },
      { name: 'תרגום חנות לשפה נוספת', price: '480 ₪ · לעמוד' },
      { name: 'שחזור עגלות נטושות אוטומטי', price: '600 ₪ · חד פעמי' },
    ],
    price: '250',
    priceFrom: true,
