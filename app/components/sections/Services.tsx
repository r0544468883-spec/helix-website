...
const corePackages: Package[] = [
  {
    ...
    addons: [
      ...
      { name: 'ניתוח אטריביוציה מולטי-צ׳אנל', price: '1,400 ₪' },
      { name: 'מיפוי מילות מפתח ל-AI Search', price: '800 ₪' },
      { name: 'קמפיין ריטרגטינג דינמי', price: '650 ₪' },
      { name: 'ניתוח מתחרים ממומן (Ad Intelligence)', price: '750 ₪' },
    ],
    price: '1,250',
    priceFrom: true,
  ...
  },
  {
    ...
    addons: [
      ...
      { name: 'הטמעת נגישות (תקן 5568)', price: '1,200 ₪' },
      { name: 'הקמת Progressive Web App (PWA)', price: '1,500 ₪' },
      { name: 'מיקרו-אנימציות ואינטראקציות', price: '900 ₪' },
      { name: 'אופטימיזציית מהירות + CDN', price: '650 ₪' },
    ],
    price: '1,250',
    priceFrom: true,
  ...
  },
  {
    ...
    addons: [
      ...
      { name: 'אוטומציית WhatsApp Business API', price: '1,200 ₪' },
      { name: 'בוט תיאום פגישות אוטומטי', price: '550 ₪' },
      { name: 'אוטומציית חשבוניות ותשלומים', price: '800 ₪' },
      { name: 'תרחיש Zapier/Make מותאם', price: '450 ₪' },
    ],
    price: '1,250',
    priceFrom: true,
  ...
  },
  {
    ...
    addons: [
      { name: 'צ׳אטבוט נוסף לפלטפורמה נוספת', price: '400 ₪/חודש' },
      { name: 'חיזוק פרופיל לינקדין (4 פוסטים חודשיים מותאמים לקהל היעד)', price: '600 ₪/חודש' },
      { name: 'הגדרת תוכנית רפרל מלאה', price: '1,800 ₪' },
      { name: 'Lead Magnet AI — מגנט לידים חכם', price: '1,200 ₪' },
      { name: 'סקרייפינג לידים ממוקד', price: '600 ₪/חודש' },
      { name: 'גיימיפיקציה לאתר / דף נחיתה', price: '1,500 ₪' },
      { name: 'אינטגרציית PLG (Product-Led Growth)', price: '900 ₪/חודש' },
      { name: 'מנוע ביקורות + UGC', price: '500 ₪/חודש' },
      { name: 'סדנת UX for Growth (חצי יום)', price: '2,200 ₪' },
      { name: 'Engineering as Marketing — כלי חינמי', price: '2,500 ₪' },
      { name: 'AI Agent Readiness Audit', price: '1,600 ₪' },
      { name: 'Sprint Growth ניסיוני (2 שבועות)', price: '1,800 ₪' },
    ],
    price: '1,250',
    priceFrom: true,
  ...
  },
  {
    ...
    addons: [
      { name: 'העשרת רשומות B2B', price: '490 ₪' },
      { name: 'ניהול תיבת LinkedIn להפניות', price: '390 ₪/חודש' },
      { name: 'כתיבת סדרת מסרים מותאמת אישית', price: '650 ₪' },
      { name: 'דשבורד מכירות + דוח ROI שבועי', price: '290 ₪/חודש' },
      { name: 'אוטומציה של פולו-אפ בדוא״ל קר', price: '350 ₪/חודש' },
      { name: 'בניית רשימת ICP ממוקדת (1,000 רשומות)', price: '850 ₪' },
      { name: 'A/B טסטינג למסרי Outreach', price: '450 ₪/חודש' },
      { name: 'סגמנטציית לידים חמים (Intent Signals)', price: '550 ₪/חודש' },
      { name: 'הקמת תשתית Multi-Channel Sequence', price: '1,100 ₪' },
    ],
    price: '1,250',
    priceFrom: true,
