...
const corePackages: Package[] = [
  ...
  },
  {
    ...
    addons: [
      { name: 'העשרת רשומות B2B — הוספת מיילים, טלפונים ונתונים לרשימה קיימת', price: '490 ₪ · חד פעמי' },
      ...
      { name: 'בניית רשימת לקוחות פוטנציאליים (1,000 רשומות לפי פרופיל אידיאלי)', price: '850 ₪ · חד פעמי' },
      { name: 'זיהוי לידים חמים — התראה כשמישהו מגלה עניין (פתח מייל, ביקר באתר)', price: '550 ₪ · חודשי' },
      { name: 'פנייה רב-ערוצית — רצף שמשלב לינקדין + אימייל + וואטסאפ בתזמון חכם', price: '1,100 ₪ · חד פעמי' },
    ],
    price: '1,250',
    priceFrom: true,
...
const extraPackages: Package[] = [
  ...
  },
  {
    ...
    items: [
      'MVP · פיצ׳ר חדש · אינטגרציה · אפליקציה · ייעוץ AI',
      'דוח חודשי מפורט',
      'פגישה שבועית של 30 דקות',
    ],
    bonuses: ['שיחת אפיון ראשונה חינם', '20% הנחה ליזמים, סטארטאפים ועסקים קטנים'],
    addons: [
      { name: 'שעת ייעוץ', price: '300 ₪' },
      { name: 'בדיקת היתכנות (3 שעות) · חוסכים 100 ₪', price: '800 ₪' },
      { name: 'ספרינט MVP (5 שעות) · חוסכים 250 ₪ ⭐ מומלץ', price: '1,250 ₪' },
      { name: 'Pay As You Go (10+ שעות) · חוסכים 80 ₪ לשעה', price: '220 ₪ · לשעה' },
    ],
    price: '300',
    priceFrom: true,
