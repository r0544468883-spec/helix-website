...
const faqs = [
  {
    q: 'מה הכלי בעצם עושה?',
    a: 'עונים על כמה שאלות על העסק, השוק והמתחרים, וצוות סוכנים מריץ ניתוח אסטרטגי מלא: מיפוי הענף, פורטר 5+1, מפת קבוצות אסטרטגיה, VRINO, SWOT עם מנוף ובטן רכה, אוקיינוס כחול, ומשפט אסטרטגי אחד שמגדיר את הקטגוריה שבה אתם יכולים להיות היחידים, עם מהלכים.',
  },
  {
