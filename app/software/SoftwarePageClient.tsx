...
const SOFTWARE: SW[] = [
  ...
  { slug: 'crm', name: 'HELIX CHIEF CRM', cat: 'CRM · חינם', accent: '#10B981', icon: '📇',
    desc: 'ה-CRM החינמי לעסקים ישראלים, אנשי קשר, עסקאות, משפכי מכירות, מצב כנסים ותיאום פגישות. ובתוכו HELIX CHIEF: סוכן ה-AI שמנהל לידים ופולואפים במקומך. הראש והידיים של כל כלי HELIX.' },
  ...
  { slug: 'store-maintenance', name: 'HELIX Ecommerce Maintenance', cat: 'תחזוקת חנות איקומרס', accent: '#FB923C', icon: '🛒',
    desc: 'תחזוקה שמדברת מסחר. 21 מנועים סורקים את כל מסלול-הקנייה, קטלוג, עגלה, צ׳ק-אאוט, סליקה ומחירים, תופסים דליפות-כסף (משלוח מתחת-לעלות, עגלה נטושה, מוצר בלי מחיר), מדרגים לפי הפגיעה בהכנסה ומתקנים בשליטת מתג אוטונומיה. WooCommerce ו-Shopify, עברית ו-RTL.' },
];
...
const DEPARTMENTS: { title: string; icon: string; slugs: string[] }[] = [
  ...
  { title: 'מכירות והכנסות', icon: '💰', slugs: ['sdr', 'shop', 'store-maintenance'] },
