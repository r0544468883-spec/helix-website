          ...
          <ScrollReveal direction="up">
            <div className="sw-wa">
              ...
              <p className="sw-wa-body">
                הבוטים שלנו שולחים הודעות דרך <strong>ה-API הרשמי והחוקי של וואטסאפ (Meta Cloud API)</strong> — ולא דרך
                כלים אפורים. זו החלטה מודעת: שליחה דרך שיטות לא-רשמיות מובילה ל<strong>חסימת המספר שלכם</strong>, ואנחנו לא
                מוכנים לסכן את העסק שלכם. הדרך הרשמית שומרת על המספר שלכם בטוח ומאושר.
              </p>
              <p className="sw-wa-body" style={{ marginTop: '12px' }}>
                בתמורה, <strong>מטא מחייבת על כל הודעה שהבוט שולח</strong> — והתעריפים האלה נקבעים על ידי מטא, משתנים לפי
                מדינה וסוג הודעה, <strong>ואין לנו שום שליטה עליהם</strong>. לכן עלות ההודעות נפרדת מהמנוי, ואתם בוחרים איך לשלם:
              </p>
