...
export const TEAMS: Record<string, TeamMember[]> = {
  whatsapp: [
    { name: 'עמנואל', role: 'המתמלל', line: 'אני מפענח כל הודעה קולית ומחזיר טקסט, סיכום והמשימות שבתוכה.', emoji: '🎙️' },
    { name: 'ליה', role: 'האנליסטית', line: 'אני קוראת את הקבוצה בזמן-אמת ומחזירה מי פעיל, מה חשוב ומי ספאמר.', emoji: '📊' },
    { name: 'דן', role: 'המחבר', line: 'אני מזהה מי בקבוצה צריך את מי, ומכין הצעת-חיבור.', emoji: '🤝' },
    { name: 'אלון', role: 'המבקר שפוסל', line: 'אני פוסל חשיפת-חיבור בלי הסכמה והסרה של חבר תמים, לפני שנוגעים באנשים.', emoji: '🔴' },
    { name: 'נעמי', role: 'הרכזת', line: 'אני זוכרת כל הבטחה ומשימה, ומזכירה לך לפני שזה נופל.', emoji: '📅' },
    CHIEF,
  ],
  'website-maintenance': [
  ...
  geo: [
    ...
    { name: 'דן', role: 'הכתב', line: 'אני כותב את המאמר עצמו, עוגן או לוויין, לפי התבנית.', emoji: '✍️' },
    ...
    { name: 'CHIEF', role: 'מתכנן-האשכול', line: 'אני מתכנן אשכול שלם, עמוד-עוגן ולוויינים סביבו שמקשרים אליו, ומחלק לצוות מאמר אחד בכל פעם.', emoji: '🧭' },
  ],
  'growth-doctor': [
