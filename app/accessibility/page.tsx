      ...
      <section className="legal">
        <div className="container">
          <div className="about-text legal-body">
            ...
            <h2>סרגל הנגישות באתר</h2>
            <p>
              בכל עמוד באתר מופיע כפתור נגישות צף (סמל האדם עם הזרועות הפתוחות).
              לחיצה עליו פותחת סרגל שמאפשר להתאים את התצוגה אישית: הגדלת טקסט,
              ניגודיות גבוהה, היפוך צבעים, הדגשת קישורים, גופן קריא, סמן עכבר
              גדול ועצירת אנימציות. הבחירות שלכם נשמרות בדפדפן וממשיכות איתכם בין
              עמודים. תמיד אפשר לאפס להגדרות ברירת המחדל בלחיצה אחת.
            </p>
