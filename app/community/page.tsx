...
const howItWorks = [
  'מעלים פוסט אחד ביום לקבוצה הרלוונטית, לינק ישיר.',
  'מפרגנים לכל שאר הפוסטים באותו מחזור, לייק ותגובה אמיתית.',
  'מסמנים בוצע, וכך המעגל נסגר וכולם צומחים יחד.',
];
  ...
  return (
    <div className="community-page">
      ...
      <ScrollReveal direction="up">
        <section className="vc-learnings">
          <div className="container">
            <SectionHeader eyebrow="המנגנון" title="איך זה עובד." as="h2" />
