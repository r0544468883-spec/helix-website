  ...
  return (
    <main dir="rtl" className="fr">
      ...
      <section className="fr-us" data-reveal>
        <div className="fr-us-grid">
          ...
          <div className="fr-us-text">
            ...
            <p>
              אנחנו יושבים באותם מפגשי בוקר, מעבירים הפניות, ומכירים את Givers Gain מבפנים.
              בנינו את הכלי הזה בדיוק בשביל העולם הזה, כי אנחנו חיים אותו בעצמנו.
            </p>
          </div>
        </div>
      </section>
      ...
      <style>{`
        ...
        .fr-door-center { position: absolute; inset: 0; z-index: 2; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 14px; text-align: center; padding: 24px; transform: translateY(-48px); transition: opacity .4s ease, transform .4s ease; }
        .fr-door.is-open .fr-door-center { opacity: 0; transform: translateY(-48px) scale(1.08); }
