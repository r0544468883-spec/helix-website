...
| **Connectors (חיים, 10)** — GA4 (OAuth) · Meta Ads · Stripe · Shopify · Plausible · Mailchimp · **HELIX OPS (A/B)** · **רב-מסר/Responder** 🇮🇱 · **ActiveTrail** 🇮🇱 · **InforU** 🇮🇱 → `metric_points` | `lib/connectors/{ga4,meta,stripe,shopify,plausible,mailchimp,helixops,ravmesser,activetrail,inforu,registry}`, `/api/connectors/*`, `/connect` |
